...
#
#python step2_evaluate_by_chatgpt.py \
#--generation_result_path "./generated/kullm_v3.jsonl" \
#--evaluation_result_path "./chatgpt_results/kullm_v3.pkl" \
#--use_api
#
#python step2_evaluate_by_chatgpt.py \
...
python step2_evaluate_by_chatgpt.py \
--generation_result_path "./generated/kullm3_prompted_bsz8.jsonl" \
--evaluation_result_path "./chatgpt_results/kullm3_prompted_bsz8.pkl" \
--use_api

python step2_evaluate_by_chatgpt.py \
--generation_result_path "./generated/kullm3_prompted_bsz16.jsonl" \
--evaluation_result_path "./chatgpt_results/kullm3_prompted_bsz16.pkl" \
--use_api